...
-- ----------------------------
INSERT INTO `drools_rules` VALUES ('1', 'helloword', '测试规则', null, null, 'rule  helloword\r\n when\r\n $d:droolsmodel();\r\n then\r\n System.out.println(\"执行成功了！\"+$d.name);\r\n end', '1', null, '2020-02-17 21:47:24');
...
INSERT INTO `sys_logininfor` VALUES ('7', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '1', '验证码已失效', '2020-03-07 14:07:44');
INSERT INTO `sys_logininfor` VALUES ('8', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '0', '登录成功', '2020-03-07 14:07:54');
INSERT INTO `sys_logininfor` VALUES ('9', 'admin', '127.0.0.1', '内网IP', 'Firefox 7', 'Windows 10', '0', '登录成功', '2020-03-07 15:39:38');
...
INSERT INTO `sys_menu` VALUES ('401', '实体管理', '4', '3', 'entitylist', 'drools/entitylist', '1', 'C', '0', '', 'druid', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '用户管理菜单');
INSERT INTO `sys_menu` VALUES ('402', '规则管理', '4', '5', 'rulelist', 'drools/rulelist', '1', 'C', '0', '', 'tree-table', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '规则列表菜单');
INSERT INTO `sys_menu` VALUES ('403', '模板管理', '4', '2', 'templatelist', 'drools/templatelist', '1', 'C', '0', '', 'dict', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '模板列表菜单');
INSERT INTO `sys_menu` VALUES ('404', '分组管理', '4', '1', 'grouplist', 'drools/grouplist', '1', 'C', '0', '', 'cascader', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '分组列表菜单');
INSERT INTO `sys_menu` VALUES ('405', '函数管理', '4', '4', 'functionlist', 'drools/functionlist', '1', 'C', '0', '', 'education', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '函数列表菜单');
